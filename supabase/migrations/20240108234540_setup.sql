...
AS $$
DECLARE
  project_url TEXT := 'https://ypokdjmeqshsopgdxvef.supabase.co';
  service_role_key TEXT := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Inlwb2tkam1lcXNoc29wZ2R4dmVmIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTcxNzI0ODQ3NywiZXhwIjoyMDMyODI0NDc3fQ.sIkKNBfz3TY7DwyhqfIhDF-KZNSXwnmlv7ufh-Rlcrw'; -- full access needed for http request to storage
